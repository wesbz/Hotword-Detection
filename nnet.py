...
class CNNTradPool1Conv1(nn.Module):
    def __init__(self):
        ...
        x = Variable(torch.zeros(1, 40, 101), volatile=True)

        self.conv1 = nn.Conv1d(40, 64, kernel_size=8, stride=1)
...
class CNNTradPool1Conv2(nn.Module):
    def __init__(self):
        super(CNNTradPool1Conv2, self).__init__()
        x = Variable(torch.zeros(1, 40, 101), volatile=True)
        ...
        self.conv2 = nn.Conv1d(64, 64, kernel_size=4, stride=1)
...
class CNNTradPool1Conv3(nn.Module):
    def __init__(self):
        super(CNNTradPool1Conv3, self).__init__()
        x = Variable(torch.zeros(1, 40, 101), volatile=True)
